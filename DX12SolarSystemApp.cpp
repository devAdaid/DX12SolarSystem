...
class DX12SolarSystemApp : public D3DApp
{
public:
    DX12SolarSystemApp(HINSTANCE hInstance);
    DX12SolarSystemApp(const DX12SolarSystemApp& rhs) = delete;
    DX12SolarSystemApp& operator=(const DX12SolarSystemApp& rhs) = delete;
    ~DX12SolarSystemApp();
    ...
    PSTR cmdLine, int showCmd)
{
    ...
    try
    {
        DX12SolarSystemApp theApp(hInstance);
...
DX12SolarSystemApp::DX12SolarSystemApp(HINSTANCE hInstance)
    : D3DApp(hInstance)
{
}

DX12SolarSystemApp::~DX12SolarSystemApp()
{
    if(md3dDevice != nullptr)
        FlushCommandQueue();
}

bool DX12SolarSystemApp::Initialize()
{
...
void DX12SolarSystemApp::OnResize()
{
    D3DApp::OnResize();
...
void DX12SolarSystemApp::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void DX12SolarSystemApp::OnMouseDown(WPARAM btnState, int x, int y)
{
    mLastMousePos.x = x;
    mLastMousePos.y = y;
...
void DX12SolarSystemApp::OnMouseUp(WPARAM btnState, int x, int y)
{
    ReleaseCapture();
}

void DX12SolarSystemApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void DX12SolarSystemApp::OnKeyboardInput(const GameTimer& gt)
{
...
void DX12SolarSystemApp::UpdateCamera(const GameTimer& gt)
{
...
void DX12SolarSystemApp::UpdateObjectCBs(const GameTimer& gt)
{
...
void DX12SolarSystemApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void DX12SolarSystemApp::BuildShadersAndInputLayout()
{
...
void DX12SolarSystemApp::BuildFrameResources()
{
